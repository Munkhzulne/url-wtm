...
export const SignOut = () => {
  ...
  useEffect(() => {
    if (isClicked === true) createUser({ email, password, rePassword });
    ...
    <Layout status="logging">
      <div className="h100 flex flex-col items-center">
        ...
        <Input
          ...
          label="Цахим хаяг"
          labelClassName="font-ubuntu fs-18 lh-23 h-4 w-38 pa-2 mt-3"
        ...
        />
        <Button
          className="font-ubuntu fs-18 lh-23 br-none up br-ra-100 bold c-default h-4 w-19 ph-4 ml-4 b-primary mt-5 pointer outline-none mb-7"
          onclick={() => createUser({ email, password, rePassword })}
        >
          Бүртгүүлэх
        </Button>
      </div>
