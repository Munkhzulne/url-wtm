...
export const Shortened = () => {
  ...
  useEffect(() => {
    document.getElementById("transformLeft").style.transform =
      "translate(30px)";
    document.getElementById("transformRigth").style.transform =
      "translate(-30px)";
    document.getElementById("leftBracket").style.transform = "translate(28px)";
    document.getElementById("rigthBracket").style.transform =
      "translate(-28px)";
  }, []);
      ...
      <div className="h100 flex flex-col items-center">
        ...
        <div className="mt-5 flex">
          <Input
            ...
            className="fs-18 lh-23 br-none bx-sh-2 br-ra-100 h-4 w-58 ph-4 outline-none"
            placeholder="https://www.web-huudas.mn"
          />
          <Button
            onclick={() => shortening()}
            className="font-ubuntu fs-18 lh-23 br-none up br-ra-100 bold c-default h-4 w-19 ph-4 ml-4 b-primary outline-none pointer"
          >
            Богиносгох
          </Button>
        </div>
        <div className="flex-col justify-between font-ubuntu">
          ...
          <div className="mt-6">
            ...
            <div className="fs-20 lh-23 mt-3" id="short">
              {links.short}
            </div>
            <div
              className="mt-4 fs-18 lh-21 c-primary pointer"
              onClick={() => copy()}
            >
              Хуулж авах
            </div>
